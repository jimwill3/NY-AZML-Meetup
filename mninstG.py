...
#created in VS code and if you run this from vs code "python integrated terminal" from the command palette the 
# cntk debugger will run
...
def create_model(features):
    ...
    with C.layers.default_options(init = C.layers.glorot_uniform(), activation = C.relu):
            ...
            #add a dense layer for testing - 8/14
            r = C.layers.Dense(96,name='Dense96')(h)            # add a layer of 96 densely connection nodes
            r = C.layers.layers.Dropout(0.5,name='DropOutB4FinalClassifier')(r)  # pre-96 layer 0.59 avg test error
            ...
            #get the weights
            progprint.log("FirstConv Weight: "+ repr(r.First_Conv.W.value))
